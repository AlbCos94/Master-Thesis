...
def main():
    ...
    global pathCSV
    pathCSV = 'LogFilesLatency/Latencytest/Concat/' + outputFileParam + '.csv'
            ...
            if y_test_curr_motion_old == y_test_curr_motion:
                if predicted_label == y_test_curr:
                    ...
                    if prediction_counter > counter_offset:
                        ...
                        offsettime = int(y_test_curr_motion.split('_')[1])
                        #print y_test_curr_motion
                        #print step_counter
                        #print window_size
                        #print predictiontime
                        #print offsettime
                        ####-Zahl in Dateinamen (offsettime)
                        # prediction_counter nicht abziehen
                        timetoprediction = (step_counter+window_size+predictiontime)-offsettime
                        ...
                        with open(pathCSV, 'a') as csvfile:
                            ...
                            csvwriter.writerow([y_test_curr_motion, timetoprediction, predictiontime, step_counter, predicted_label, offsettime])
                        k = 1
                        prediction_counter = 0
                        o = 0
                else:
